...
import com.chatgpt.cache.ChatGPTCache;
import com.chatgpt.listener.ToolsSettingActionListener;
import com.chatgpt.model.SettingsRowModel;
...
public class ChatGPTConfig implements Configurable {
    ...
    public static final String PLUGIN_NAME = "Miss Flare";
